...
export const campaignChapters: CampaignChapter[] = [
  {
    ...
    description:
      "You emerge from the Eternal Sleep Chamber into a world transformed by catastrophe. The great empire has fallen, but hope remains in the scattered survivors who look to you for guidance.",
    starRating: 1,
    estimatedTurns: [15, 25],
    theme: "Discovery and Basic Survival",
    coreChallenge:
      "Establish your first settlement and discover the nature of the catastrophe",
    prerequisites: [],
    victoryConditions: [
      {
    ...
    storyEvents: [
      {
        ...
        description:
          "You awaken in the Eternal Sleep Chamber, the last of the Architects to emerge from stasis. The world outside is changed beyond recognition.",
        ...
        choices: [
            ...
            consequences: [
              {
                ...
                target: "all_factions",
                value: 10,
                description: "Improved relations with survivor factions",
                permanent: false,
              },
              {
                type: "resources",
                target: "influence",
                value: 25,
                description: "Gained influence through leadership",
                permanent: false,
              },
            ],
            morality: "good",
          ...
          },
          {
            ...
            description:
              "Ensure the safety of the chamber and its remaining technology",
            requirements: [],
            consequences: [
              {
                type: "resources",
              ...
              {
                type: "unlock",
                target: "chamber_technologies",
                value: 1,
                description: "Unlocked chamber technologies",
                permanent: true,
              },
            ],
            morality: "neutral",
      ...
      },
      {
        ...
        title: "First Contact",
        description:
          "You encounter the Ember Keepers, a faction dedicated to preserving the last flames of civilization.",
    ...
    specialRules: [
      {
        ...
        description:
          "Research speed increased by 50% as you recall ancient knowledge",
    ...
    rewards: [
      {
        type: "research",
        description: "Unlock Tier 2 Infrastructure Research",
        value: "infrastructure_tier_2",
      },
      {
        type: "commanders",
        description: "Recruit Elite Architect unit",
        value: 1,
      },
      {
        type: "legacy",
        description: "The Awakening legacy bonus for future campaigns",
        value: "awakening_legacy",
      },
    ],
  },
  {
    ...
    description:
      "The survivor factions have taken notice of your growing power. Navigate treacherous politics while building the strength needed to weather the coming storms.",
    starRating: 2,
    estimatedTurns: [25, 40],
    theme: "Faction Diplomacy and Early Conflicts",
    coreChallenge:
      "Navigate the complex web of survivor factions while building strength",
    ...
    storyEvents: [
      {
        ...
        description:
          "Representatives from all major factions gather for the first inter-faction meeting since the Sundering.",
        ...
        choices: [
            ...
            consequences: [
              {
                ...
                target: "all_factions",
                value: 20,
                description: "Improved relations with all factions",
                permanent: false,
              },
              {
                type: "story",
                target: "unity_path",
                value: 1,
                description: "Set on path of unity",
                permanent: true,
              },
            ],
            morality: "good",
          ...
          },
          {
            ...
            consequences: [
              {
                type: "diplomacy",
                target: "weak_factions",
                value: 30,
                description: "Intimidated weaker factions",
                permanent: false,
              },
              {
                type: "diplomacy",
                target: "strong_factions",
                value: -20,
                description: "Angered stronger factions",
                permanent: false,
              },
              {
                type: "story",
                target: "dominance_path",
                value: 1,
                description: "Set on path of dominance",
                permanent: true,
              },
            ],
            morality: "evil",
    ...
    specialRules: [
      {
        ...
        description:
          "Diplomatic actions have increased impact due to growing faction rivalries",
    ...
    rewards: [
      {
        type: "research",
        description: "Unlock Advanced Military Technologies",
        value: "military_tier_2",
      },
      {
        type: "resources",
        description: "Diplomatic Treasury (+1000 Gold)",
        value: 1000,
      },
      {
        type: "legacy",
        description: "Diplomatic Mastery legacy bonus",
        value: "diplomacy_legacy",
      },
    ],
  },
  {
    ...
    description:
      "Ancient vaults reveal their secrets, but with them come dangers the old world couldn't control. Balance progress with prudence as you unlock the power of the past.",
    starRating: 3,
    estimatedTurns: [30, 50],
    theme: "Technology Recovery and Ancient Mysteries",
    coreChallenge:
      "Recover pre-Sundering technologies while dealing with their dangers",
    ...
    storyEvents: [
      {
        ...
        description:
          "You discover the Technomancer's Vault, sealed since the Sundering and containing dangerous but powerful knowledge.",
        triggerConditions: [
          {
            type: "research",
            condition: "completed",
        ...
        choices: [
          {
            ...
            description:
              "Take time to understand the safeguards before proceeding",
            ...
            consequences: [
              {
                ...
                target: "knowledge",
                value: 200,
                description: "Safely extracted knowledge",
                permanent: false,
              },
              {
                type: "unlock",
                target: "safe_technology_path",
                value: 1,
                description: "Unlocked safe research methods",
                permanent: true,
              },
            ],
            morality: "good",
          ...
          },
          {
            ...
            description:
              "Time is precious - take the knowledge now and deal with consequences later",
            requirements: [],
            consequences: [
              {
                type: "resources",
                target: "knowledge",
                value: 500,
                description: "Massive knowledge gain",
                permanent: false,
              },
              {
                type: "story",
                target: "corruption_risk",
                value: 1,
                description: "Increased corruption risk",
                permanent: true,
              },
              {
                type: "unlock",
                target: "dangerous_technology_path",
                value: 1,
                description: "Unlocked dangerous research",
                permanent: true,
              },
            ],
            morality: "neutral",
    ...
    specialRules: [
      {
        ...
        description:
          "Artifacts provide bonus research points when studying related technologies",
        effects: [
          {
            type: "artifact_research_bonus",
            modifier: 2.0,
            target: "related_tech",
          },
        ],
    ...
    rewards: [
      {
        type: "research",
        description: "Unlock Lost Knowledge specialization",
        value: "lost_knowledge_mastery",
      },
      {
        type: "resources",
        description: "Ancient Artifact Collection (+5 Artifacts)",
        value: 5,
      },
      {
        type: "legacy",
        description: "Knowledge Seeker legacy bonus",
        value: "knowledge_legacy",
      },
    ],
  },
  {
    ...
    description:
      "The corruption left by the Sundering spreads like a plague across the land. Face the dark choices of how to deal with this taint while maintaining your moral compass.",
    starRating: 3,
    estimatedTurns: [35, 55],
    theme: "Corruption and Moral Choices",
    coreChallenge:
      "Purify corruption while maintaining your values and strength",
    ...
    victoryConditions: [
      ...
      },
      {
        ...
        type: "special",
        description:
          "Maintain consistent moral alignment across major decisions",
        target: 1,
        current: 0,
        completed: false,
        optional: false,
    ...
    storyEvents: [
      {
        ...
        description:
          "You discover a sacred grove twisted by corruption. The choice of how to handle it will define your approach to the taint.",
            ...
            consequences: [
              {
                ...
                target: "mana",
                value: -200,
                description: "Massive mana expenditure",
                permanent: false,
              },
              {
                type: "unlock",
                target: "purification_mastery",
                value: 1,
                description: "Unlocked purification research",
                permanent: true,
              },
              {
                type: "story",
                target: "purifier_path",
                value: 1,
                description: "Set on purifier path",
                permanent: true,
              },
            ],
            morality: "good",
            ...
            consequences: [
              {
                ...
                target: "energy",
                value: 500,
                description: "Gained dark energy",
                permanent: false,
              },
              {
                type: "unlock",
                target: "corruption_mastery",
                value: 1,
                description: "Unlocked corruption research",
                permanent: true,
              },
              {
                type: "story",
                target: "corruptor_path",
                value: 1,
                description: "Set on corruptor path",
                permanent: true,
              },
            ],
            morality: "evil",
            ...
            consequences: [
              {
                ...
                target: "knowledge",
                value: 300,
                description: "Gained corruption knowledge",
                permanent: false,
              },
              {
                type: "unlock",
                target: "balanced_approach",
                value: 1,
                description: "Unlocked balanced research",
                permanent: true,
              },
              {
                type: "story",
                target: "scholar_path",
                value: 1,
                description: "Set on scholar path",
                permanent: true,
              },
            ],
            morality: "neutral",
      ...
      },
      {
        ...
        description:
          "A group of survivors has begun worshipping the corruption, claiming it grants them power and purpose.",
        ...
        choices: [
          {
            ...
            description:
              "Use diplomacy and healing to bring them back to the light",
            ...
            consequences: [
              {
                ...
                target: "loyalty",
                value: 20,
                description: "Population loyalty increased",
                permanent: false,
              },
              {
                type: "resources",
                target: "culture",
                value: 100,
                description: "Cultural influence gained",
                permanent: false,
              },
            ],
            morality: "good",
            ...
            consequences: [
              {
                ...
                target: "fear",
                value: 15,
                description: "Population fear increased",
                permanent: false,
              },
              {
                type: "resources",
                target: "materials",
                value: 150,
                description: "Recovered cult resources",
                permanent: false,
              },
            ],
            morality: "evil",
            ...
            consequences: [
              {
                ...
                target: "knowledge",
                value: 200,
                description: "Gained secret knowledge",
                permanent: false,
              },
              {
                type: "story",
                target: "cult_infiltration",
                value: 1,
                description: "Ongoing cult infiltration",
                permanent: true,
              },
            ],
            morality: "neutral",
    ...
    specialRules: [
      {
        ...
        effects: [
          {
            type: "corruption_growth",
            modifier: 0.05,
            target: "all_territories",
          },
        ],
        duration: "chapter",
      },
    ...
    rewards: [
      {
        type: "research",
        description: "Unlock Transcendence research paths",
        value: "transcendence_tier_1",
      },
      {
        type: "resources",
        description: "Moral Clarity bonus (+500 Culture)",
        value: 500,
      },
      {
        type: "legacy",
        description: "Corruption Handler legacy bonus",
        value: "corruption_legacy",
      },
    ],
  },
  {
    ...
    description:
      "The land itself bears scars from the Sundering. Lead the greatest ecological restoration project in history while balancing the needs of nature and civilization.",
    starRating: 4,
    estimatedTurns: [40, 65],
    theme: "Environmental Restoration and Balance",
    coreChallenge:
      "Restore the natural world while maintaining technological progress",
    ...
    storyEvents: [
      {
        ...
        description:
          "You discover the final surviving World Tree, ancient beyond measure but dying from the Sundering's poison.",
        triggerConditions: [
          {
            type: "research",
            condition: "completed",
            value: "deep_earth_communion",
          },
        ],
        choices: [
          {
            ...
            description:
              "Use all your resources to save this irreplaceable ancient",
            requirements: ["nature_magic_mastery", "purification_complete"],
            consequences: [
              {
                type: "unlock",
                target: "world_tree_network",
                value: 1,
                description: "Unlocked world tree restoration",
                permanent: true,
              },
              {
                type: "resources",
                target: "all",
                value: -50,
                description: "Massive resource sacrifice",
                permanent: false,
              },
              {
                type: "special",
                target: "nature_blessing",
                value: 1,
                description: "Permanent nature blessing",
                permanent: true,
              },
            ],
            morality: "good",
            ...
            consequences: [
              {
                ...
                target: "energy",
                value: 2000,
                description: "Immense energy gain",
                permanent: false,
              },
              {
                type: "unlock",
                target: "exploitation_tech",
                value: 1,
                description: "Unlocked exploitation technologies",
                permanent: true,
              },
              {
                type: "special",
                target: "nature_curse",
                value: 1,
                description: "Nature turns against you",
                permanent: true,
              },
            ],
            morality: "evil",
          ...
          },
          {
            ...
            description:
              "Merge your civilization with the tree in perfect harmony",
            requirements: ["biotechnology_mastery", "philosophical_evolution"],
            consequences: [
              {
                type: "unlock",
                target: "bio_civilization",
                value: 1,
                description: "Unlocked biological civilization",
                permanent: true,
              },
              {
                type: "special",
                target: "nature_symbiosis",
                value: 1,
                description: "Perfect nature integration",
                permanent: true,
              },
            ],
            morality: "neutral",
    ...
    specialRules: [
      {
        ...
        description:
          "Natural systems respond dynamically to your restoration efforts",
        effects: [
          {
            type: "environmental_feedback",
            modifier: 1.5,
            target: "restoration_projects",
          },
        ],
        duration: "chapter",
      },
    ...
    rewards: [
      {
        type: "research",
        description: "Unlock Transcendent Harmony technologies",
        value: "harmony_transcendence",
      },
      {
        type: "resources",
        description: "Living World bonus (renewable resources)",
        value: "renewable_abundance",
      },
      {
        type: "legacy",
        description: "World Healer legacy bonus",
        value: "restoration_legacy",
      },
    ],
  },
  {
    ...
    description:
      "With the world healing and knowledge restored, it's time to create a culture that surpasses even the ancient empire. Guide the greatest artistic and intellectual flowering in history.",
    starRating: 4,
    estimatedTurns: [45, 70],
    theme: "Cultural Development and Human Achievement",
    coreChallenge:
      "Create a cultural golden age that inspires and unifies all peoples",
    ...
    victoryConditions: [
      ...
      },
      {
        ...
        type: "special",
        description:
          "Launch 3 major artistic movements across different domains",
        target: 3,
        current: 0,
        completed: false,
        optional: false,
    ...
    storyEvents: [
      {
        ...
        description:
          "Scholars, artists, and philosophers from across the land gather for the greatest intellectual gathering since the ancient academies.",
        ...
        choices: [
          {
            ...
            consequences: [
              {
                type: "culture",
                target: "diversity_bonus",
                value: 50,
                description: "Cultural diversity flourishes",
                permanent: false,
              },
              {
                type: "unlock",
                target: "democratic_culture",
                value: 1,
                description: "Unlocked democratic cultural systems",
                permanent: true,
              },
            ],
            morality: "good",
          ...
          },
          {
            ...
            consequences: [
              {
                type: "culture",
                target: "excellence_bonus",
                value: 75,
                description: "Cultural excellence achieved",
                permanent: false,
              },
              {
                type: "unlock",
                target: "aristocratic_culture",
                value: 1,
                description: "Unlocked aristocratic cultural systems",
                permanent: true,
              },
            ],
            morality: "neutral",
    ...
    specialRules: [
      {
        ...
        description:
          "All cultural and research projects benefit from renaissance spirit",
        effects: [
          { type: "cultural_research_bonus", modifier: 2.0, target: "all" },
        ],
        duration: "chapter",
      },
    ],
    rewards: [
      {
        type: "research",
        description: "Unlock Final Transcendence paths",
        value: "final_transcendence",
      },
      {
        type: "resources",
        description: "Cultural Legacy (+2000 Culture)",
        value: 2000,
      },
      {
        type: "legacy",
        description: "Renaissance Master legacy bonus",
        value: "renaissance_legacy",
      },
    ],
  },
  {
    ...
    description:
      "The world is healed, knowledge is restored, and culture flourishes. Now you must choose the ultimate destiny for your civilization and all who will come after.",
    starRating: 5,
    estimatedTurns: [50, 100],
    theme: "Transcendence and Ultimate Destiny",
    coreChallenge:
      "Choose and achieve the ultimate destiny for your civilization",
    ...
    storyEvents: [
      {
        ...
        description:
          "The moment of ultimate decision arrives. What legacy will you leave for the ages?",
        triggerConditions: [
          {
            type: "research",
            condition: "completed_any",
            value: "transcendence_research",
          },
        ],
        choices: [
          {
            ...
            consequences: [
              {
                type: "special",
                target: "harmony_victory",
                value: 1,
                description: "Harmony Victory achieved",
                permanent: true,
              },
            ],
            morality: "good",
          ...
          },
          {
            ...
            consequences: [
              {
                type: "special",
                target: "ascension_victory",
                value: 1,
                description: "Ascension Victory achieved",
                permanent: true,
              },
            ],
            morality: "neutral",
          ...
          },
          {
            ...
            consequences: [
              {
                type: "special",
                target: "dominion_victory",
                value: 1,
                description: "Dominion Victory achieved",
                permanent: true,
              },
            ],
            morality: "evil",
    ...
    specialRules: [
      {
        ...
        description:
          "Reality itself bends to accommodate your approaching transcendence",
        effects: [
          { type: "reality_manipulation", modifier: 10.0, target: "all" },
        ],
        duration: "chapter",
      },
    ],
    rewards: [
      {
        type: "legacy",
        description: "Master of Aeloria - Ultimate achievement",
        value: "master_of_aeloria",
      },
      {
        type: "legacy",
        description: "Your chosen transcendence path legacy",
        value: "transcendence_chosen",
      },
      {
        type: "legacy",
        description: "Eternal remembrance across all future games",
        value: "eternal_legacy",
      },
    ],
  },
];
...
export const researchTree: ResearchNode[] = [
    ...
    effects: [
      {
        ...
        target: "growth_rate",
        value: 0.1,
        description: "Population growth +10%",
      },
      {
        type: "unlock",
        target: "basic_housing",
        value: 1,
        description: "Unlocks basic housing construction",
      },
    ],
    special: false,
  },
    ...
    effects: [
      {
        ...
        target: "efficiency",
        value: 0.15,
        description: "Production efficiency +15%",
      },
      {
        type: "unlock",
        target: "administrative_centers",
        value: 1,
        description: "Unlocks administrative buildings",
      },
    ],
    special: false,
  },
  {
    ...
    storyText:
      "The first architects of the new age draft blueprints for tomorrow.",
    tier: 1,
    branch: "infrastructure",
    cost: { knowledge: 200 },
    ...
    effects: [
      {
        type: "unlock",
        target: "urban_districts",
        value: 1,
        description: "Unlocks specialized urban districts",
      },
      {
        type: "population",
        target: "capacity",
        value: 0.25,
        description: "Settlement capacity +25%",
      },
    ],
    special: false,
  },
  ...
  // TIER 2: ADVANCED INFRASTRUCTURE
  {
    ...
    storyText:
      "We shall build monuments that dwarf even the old empire's glory.",
    tier: 2,
    branch: "infrastructure",
    ...
    effects: [
      {
        type: "unlock",
        target: "mega_structures",
        value: 1,
        description: "Unlocks wonder buildings",
      },
      {
        type: "culture",
        target: "influence",
        value: 0.3,
        description: "Cultural influence +30%",
      },
    ],
    special: false,
  },
  {
    ...
    storyText:
      "The ancient styles live again, but improved by hard-won wisdom.",
    tier: 2,
    branch: "infrastructure",
    ...
    effects: [
      {
        type: "unlock",
        target: "imperial_buildings",
        value: 1,
        description: "Unlocks imperial-style buildings",
      },
      {
        type: "culture",
        target: "bonus",
        value: 0.25,
        description: "Cultural bonuses +25%",
      },
    ],
    ...
    effects: [
      {
        ...
        target: "basic_spells",
        value: 1,
        description: "Unlocks basic magic",
      },
      {
        type: "production",
        target: "magical_efficiency",
        value: 0.15,
        description: "Magical efficiency +15%",
      },
    ],
    special: false,
  },
  {
    ...
    effects: [
      {
        type: "unlock",
        target: "high_level_spells",
        value: 1,
        description: "Unlocks high-level spells",
      },
      {
        type: "military",
        target: "archmage_units",
        value: 1,
        description: "Unlocks Archmage units",
      },
    ],
    chapterUnlock: "chapter_3_echoes_knowledge",
    special: true,
  ...
  // LOST KNOWLEDGE BRANCH
  {
    ...
    effects: [
      {
        type: "special",
        target: "direct_knowledge_transfer",
        value: 1,
        description: "Direct knowledge transfer from pre-Sundering era",
      },
      {
        type: "production",
  ...
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "instant_construction",
        value: 1,
        description: "Instant construction techniques",
      },
      {
        type: "unlock",
        target: "wonder_buildings",
        value: 1,
        description: "Unlocks wonder buildings",
      },
    ],
  ...
  // CORRUPTION AND PURIFICATION BRANCH
  {
    ...
    effects: [
      {
        type: "military",
        target: "corruption_defense",
        value: 0.5,
        description: "Corruption defense +50%",
      },
      {
        type: "unlock",
        target: "corruption_research",
        value: 1,
        description: "Unlocks corruption research options",
      },
    ],
  ...
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "purification_spells",
        value: 1,
        description: "Unlocks purification spells",
      },
      {
        type: "production",
        target: "land_healing",
        value: 0.3,
        description: "Land healing efficiency +30%",
      },
    ],
    chapterUnlock: "chapter_4_shadows_corruption",
    special: false,
    ...
    effects: [
      {
        ...
        target: "dark_magic",
        value: 1,
        description: "Unlocks dark magic abilities",
      },
      {
        type: "production",
        target: "energy_generation",
        value: 0.4,
        description: "Energy generation +40%",
      },
    ],
    chapterUnlock: "chapter_4_shadows_corruption",
    special: false,
  ...
  // ENVIRONMENTAL RESTORATION BRANCH
  {
    ...
    effects: [
      {
        type: "special",
        target: "planet_communication",
        value: 1,
        description: "Direct communication with planetary systems",
      },
      {
        type: "production",
        target: "environmental_efficiency",
        value: 0.5,
        description: "Environmental restoration +50%",
      },
    ],
  ...
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "weather_manipulation",
        value: 1,
        description: "Control weather patterns",
      },
      {
        type: "production",
        target: "agricultural_bonus",
        value: 0.6,
        description: "Agricultural efficiency +60%",
      },
    ],
    chapterUnlock: "chapter_5_environmental_restoration",
    special: true,
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "ecosystem_creation",
        value: 1,
        description: "Create new ecosystems",
      },
      {
        type: "production",
        target: "biodiversity_bonus",
        value: 0.4,
        description: "Biodiversity restoration +40%",
      },
    ],
    chapterUnlock: "chapter_5_environmental_restoration",
    special: true,
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "perfect_ecosystem",
        value: 1,
        description: "Perfect ecosystem balance",
      },
      {
        type: "production",
        target: "sustainability_perfect",
        value: 1.0,
        description: "Perfect sustainability achieved",
      },
    ],
    chapterUnlock: "chapter_5_environmental_restoration",
    special: true,
  ...
  // CULTURAL RENAISSANCE BRANCH
  {
    ...
    description:
      "Artistic expression that touches the soul and transcends reality",
    ...
    effects: [
      {
        type: "culture",
        target: "inspiration_bonus",
        value: 0.8,
        description: "Cultural inspiration +80%",
      },
      {
        type: "unlock",
        target: "masterwork_creation",
        value: 1,
        description: "Unlocks creation of cultural masterworks",
      },
    ],
  ...
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "new_philosophy",
        value: 1,
        description: "Revolutionary philosophical frameworks",
      },
      {
        type: "production",
        target: "research_insight",
        value: 0.6,
        description: "Research insight bonus +60%",
      },
    ],
    chapterUnlock: "chapter_6_cultural_renaissance",
    special: true,
  },
  {
    ...
    description:
      "Moral frameworks that apply across all civilizations and species",
    ...
    effects: [
      {
        type: "special",
        target: "universal_morality",
        value: 1,
        description: "Universal moral framework",
      },
      {
        type: "diplomacy",
        target: "universal_respect",
        value: 1.0,
        description: "Universal diplomatic bonus",
      },
    ],
    chapterUnlock: "chapter_6_cultural_renaissance",
    special: true,
  ...
  // TRANSCENDENCE PROTOCOLS
  {
    ...
    effects: [
      {
        type: "special",
        target: "perfect_balance",
        value: 1,
        description: "Perfect balance between technology, magic, and nature",
      },
      {
        type: "special",
        target: "harmony_victory",
        value: 1,
        description: "Unlocks Harmony Victory condition",
      },
    ],
  ...
  },
  {
    ...
    effects: [
      ...
      },
      {
        ...
        target: "ascension_victory",
        value: 1,
        description: "Unlocks Ascension Victory condition",
      },
    ],
    chapterUnlock: "chapter_7_dawn_new_age",
    special: true,
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "reality_control",
        value: 1,
        description: "Complete control over reality",
      },
      {
        type: "special",
        target: "dominion_victory",
        value: 1,
        description: "Unlocks Dominion Victory condition",
      },
    ],
    chapterUnlock: "chapter_7_dawn_new_age",
    special: true,
  ...
  // SUPPORTING TECHNOLOGIES
  {
    ...
    effects: [
      {
        type: "unlock",
        target: "nature_spells",
        value: 1,
        description: "Unlocks nature magic",
      },
      {
        type: "production",
        target: "natural_harmony",
        value: 0.2,
        description: "Natural harmony bonus +20%",
      },
    ],
    special: false,
  },
  {
    ...
    effects: [
      {
        type: "culture",
        target: "synthesis_bonus",
        value: 0.3,
        description: "Cultural synthesis bonus +30%",
      },
      {
        type: "unlock",
        target: "unified_culture",
        value: 1,
        description: "Unlocks unified cultural systems",
      },
    ],
    special: false,
  },
    ...
    effects: [
      {
        ...
        value: 1,
        description: "Manipulate fundamental reality",
      },
      {
        type: "unlock",
        target: "transcendent_magic",
        value: 1,
        description: "Unlocks transcendent magic",
      },
    ],
    chapterUnlock: "chapter_6_cultural_renaissance",
    special: true,
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "transcendent_insight",
        value: 1,
        description: "Transcendent wisdom and insight",
      },
      {
        type: "production",
        target: "all_research",
        value: 0.5,
        description: "All research +50%",
      },
    ],
    chapterUnlock: "chapter_6_cultural_renaissance",
    special: true,
  },
  {
    ...
    effects: [
      {
        type: "special",
        target: "eternal_legacy",
        value: 1,
        description: "Eternal preservation of civilization",
      },
      {
        type: "special",
        target: "knowledge_eternity",
        value: 1,
        description: "Knowledge preserved for all time",
      },
    ],
    chapterUnlock: "chapter_7_dawn_new_age",
    special: true,
...
export const getAvailableResearchNodes = (
  ...
  return researchTree.filter((node) => {
    ...
    const chapterUnlocked =
      !node.chapterUnlock || chapterProgress.includes(node.chapterUnlock);
...
export const calculateResearchCost = (
  ...
  Object.keys(baseCost).forEach((resource) => {
    ...
    baseCost[resource as keyof ResearchCost] = Math.floor(
      (baseCost[resource as keyof ResearchCost] || 0) * modifier,
    );
  });
...
export const getNextChapter = (
  ...
  const currentIndex = campaignChapters.findIndex(
...
export const checkChapterVictoryConditions = (
