...
export const InfoPanel: React.FC = () => {
  ...
  const commander =
    selectedCommander !== null ? commanders.find(c => c.id === selectedCommander) : null;
        ...
        {node ? (
                            ...
                            >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="text-xs text-green-600">
                                  Level {assignedCommander.level} • Stationed here
                                </div>
                              </div>
                              <Button
                                variant="secondary"
                          ...
                          <div className="space-y-2">
                            ...
                            {availableCommanders.slice(0, 3).map(availableCommander => (
                              <Button
                                ...
                                onClick={() =>
                                  handleAssignCommander(availableCommander.id, node.id)
                                }
                              >
                                <span className="mr-2">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
              <span className="text-2xl">{gameData.commanderClasses[commander.class].icon}</span>
