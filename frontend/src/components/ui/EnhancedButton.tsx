...
const VARIANT_CLASSES = {
  ...
  danger: 'bg-blood text-light-enhanced border-blood hover:bg-blood-light hover:animate-battle-shake focus:ring-blood',
  warning: 'bg-amber text-dark-enhanced border-amber hover:bg-amber-light hover:animate-ember-glow focus:ring-amber',
